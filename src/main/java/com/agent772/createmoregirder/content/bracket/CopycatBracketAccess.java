...
public interface CopycatBracketAccess {
    ...
    /**
     * Drain and return the mimic ItemStack stashed by the most recent
     * remove/replace call (wrench or apply-replace). Returns {@link ItemStack#EMPTY}
     * if there is no pending mimic to return.
     *
     * Callers in player-facing flows (wrench, apply-replace) use this to
     * deposit the mimic into the player's inventory, respecting creative.
     */
