...
public class WaxedExposedCopperMetalGirderBlock extends CopperMetalGirderBlock {
    private static final int placementHelperId =
            PlacementHelpers.register(new WaxedExposedCopperMetalGirderPlacementHelper());

    public WaxedExposedCopperMetalGirderBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }

    @Override
    protected BlockEntry<? extends Block> getEncasedShaftBlock() {
        return CMGBlocks.WAXED_EXPOSED_COPPER_METAL_GIRDER_ENCASED_SHAFT;
    }
