...
public class WaxedWeatheredCopperMetalGirderBlock extends CopperMetalGirderBlock {
    private static final int placementHelperId =
            PlacementHelpers.register(new WaxedWeatheredCopperMetalGirderPlacementHelper());

    public WaxedWeatheredCopperMetalGirderBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }

    @Override
    protected BlockEntry<? extends Block> getEncasedShaftBlock() {
        return CMGBlocks.WAXED_WEATHERED_COPPER_METAL_GIRDER_ENCASED_SHAFT;
    }
