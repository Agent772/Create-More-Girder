...
public class BrassMetalGirderEncasedShaftBlock extends CMGGirderEncasedShaftBlock {
    public BrassMetalGirderEncasedShaftBlock(Properties properties) {
        super(properties);
    }

    @Override
    protected BlockEntry<? extends Block> getGirderBlock() {
        return CMGBlocks.BRASS_METAL_GIRDER;
    }

    @Override
    protected BlockEntityType<? extends KineticBlockEntity> getEncasedBEType() {
        return CMGBlockEntityTypes.ENCASED_BRASS_METAL_GIRDER.get();
    }
}
