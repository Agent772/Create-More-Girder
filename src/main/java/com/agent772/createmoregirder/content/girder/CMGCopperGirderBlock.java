...
/**
 * Shared base for every copper girder block, both the plain
 * {@code copper_girder} family and the OG-style {@code copper_metal_girder}
 * family. Adds copper waxing, axe scraping and random-tick oxidation on top of
 * the shaft / wrench / placement behavior provided by {@link CMGGirderBlock}.
 *
 ...
 * {@link #getNextWeatherBlock} hooks at the appropriate map
 * ({@code WeatheringCopperGirders} or {@code WeatheringCopperMetalGirders}).
 */
