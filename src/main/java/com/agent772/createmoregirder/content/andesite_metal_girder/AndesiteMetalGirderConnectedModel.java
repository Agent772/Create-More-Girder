 ...
 *
 * The variant-specific partial models are resolved at render time from
 ...
 */
public class AndesiteMetalGirderConnectedModel extends ConnectedGirderModel {

    private static final ModelProperty<PoleCtState> POLE_CT_PROPERTY = new ModelProperty<>();

    public AndesiteMetalGirderConnectedModel(BakedModel originalModel) {
        super(originalModel);
    }
