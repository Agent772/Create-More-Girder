...
public class IronGirderBlock extends CMGGirderBlock {
    ...
    public IronGirderBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        ...
        if (AllBlocks.SHAFT.isIn(stack)) {
            KineticBlockEntity.switchToBlockState(level, pos, CMGBlocks.IRON_GIRDER_ENCASED_SHAFT.getDefaultState()
