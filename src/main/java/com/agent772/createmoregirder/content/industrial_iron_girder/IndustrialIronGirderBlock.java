...
public class IndustrialIronGirderBlock extends AndesiteGirderBlock {
    private static final int placementHelperId = PlacementHelpers.register(new IndustrialIronGirderPlacementHelper());

    public IndustrialIronGirderBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        ...
        if (AllBlocks.SHAFT.isIn(stack)) {
            KineticBlockEntity.switchToBlockState(level, pos, CMGBlocks.INDUSTRIAL_IRON_GIRDER_ENCASED_SHAFT.getDefaultState()
