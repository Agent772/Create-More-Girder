...
public class WeatheredIndustrialIronGirderBlock extends AndesiteGirderBlock {
    private static final int placementHelperId = PlacementHelpers.register(new WeatheredIndustrialIronGirderPlacementHelper());

    public WeatheredIndustrialIronGirderBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        ...
        if (AllBlocks.SHAFT.isIn(stack)) {
            KineticBlockEntity.switchToBlockState(level, pos, CMGBlocks.WEATHERED_INDUSTRIAL_IRON_GIRDER_ENCASED_SHAFT.getDefaultState()
