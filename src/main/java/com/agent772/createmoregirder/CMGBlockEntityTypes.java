...
public class CMGBlockEntityTypes {
       ...
       public static final BlockEntityEntry<GirderStrutBlockEntity> GIRDER_STRUT = REGISTRATE.blockEntity("girder_strut", GirderStrutBlockEntity::new)
            .validBlocks(
                CMGBlocks.ANDESITE_GIRDER_STRUT,
                CMGBlocks.BRASS_GIRDER_STRUT,
                CMGBlocks.WAXED_COPPER_GIRDER_STRUT,
                CMGBlocks.WAXED_EXPOSED_COPPER_GIRDER_STRUT,
                ...
                CMGBlocks.WAXED_COPPER_METAL_GIRDER_STRUT,
